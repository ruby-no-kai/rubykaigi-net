...
parent {
  id: 21009,
  subnet: '10.33.90.0/24',
  pools: [
    { pool: '10.33.90.200 - 10.33.90.250' },
  ],
  'option-data': std.map(
    function(o)
      if o.name == 'routers' then o { data: '10.33.90.254' }
  ...
  reservations: (import './reservations_asset_tag.libsonnet')('10.33.90'),
}
